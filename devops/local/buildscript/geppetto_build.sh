...
APPLICATION='/asdfghjklzxcvbnmqwerttyuoo'
...
WEBIMAGENAME='geppettotest/asdfghjklzxcvbnmqwerttyuoo-web:1.0'
...
helm install --name asdfghjklzxcvbnmqwerttyuoo-1645 ./helm
if [ $? -eq 0 ]; then
